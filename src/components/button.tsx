export enum ButtonVariants {
    ...
    disabled_base = "!transition-none active:!scale-100",

    // 기본
    white = `${ButtonVariants.base} bg-c_white text-c_primary_softlight`,
    white_disabled = `${ButtonVariants.base} ${ButtonVariants.disabled_base} bg-c_white text-c_primary_softlight`,
    ...
    disabled = `${ButtonVariants.base} ${ButtonVariants.disabled_base} bg-[#F4F4F4] text-[#A9A9A9]`,
